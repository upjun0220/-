...
SOP_CATEGORIES = ['01_감전_LOTO', '02_협착_끼임', '03_낙상_응급처치',
                  '04_예지보전', '05_위험성평가_비상']
...
EVENT_CATEGORY = {
    ...
    'stationary_anomaly':  ('01_감전_LOTO', '02_협착_끼임'),
}
# ══════════════════════════════════════════════════════════════════════
...
GATE_META = {
    'ds_peak':  {'ko': '순간 움직임', 'why': '낙상 순간의 급격한 움직임',
                 'src': '8/12 B·C·D 낙상 30회 임시값'},
    'ds_mean':  {'ko': '지속 움직임', 'why': '계속 움직이는 동작인지 확인',
                 'src': '8/12 B·C·D 낙상 30회 임시값'},
